...
DLLEXPORT_FUNC(WINBOOL, LockFileEx,
               (HANDLE hFile, DWORD dwFlags, DWORD dwReserved, DWORD nNumberOfBytesToLockLow, DWORD nNumberOfBytesToLockHigh,
  ...
  NTSTATUS Status = NtLockFile(hFile, nullptr, nullptr, nullptr, nullptr, &ByteOffset, &Length, 0,
                               !!(dwFlags & LOCKFILE_FAIL_IMMEDIATELY), !!(dwFlags & LOCKFILE_EXCLUSIVE_LOCK));
  return WinAPIReturn(Status);
}
